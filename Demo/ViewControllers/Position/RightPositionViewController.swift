//
//  RightPositionViewController.swift
...
class RightPositionViewController: UIViewController {
    ...
    private func constructView() {
        ...
        titleContainerStyle.position = .right
    ...
    private func constructNavigationBar() {
        self.navigationItem.title = "Right Position"
...
extension RightPositionViewController: JSSegmentControlDataSource {
...
extension RightPositionViewController: JSSegmentControlDelegate {
