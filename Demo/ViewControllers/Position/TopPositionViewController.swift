//
//  TopPositionViewController.swift
...
class TopPositionViewController: UIViewController {
    ...
    private func constructView() {
        ...
        titleStyle.containerWidth = 120.0
        titleStyle.containerHeight = 60.0
        ...
        titleContainerStyle.position = .top
    ...
    private func constructNavigationBar() {
        self.navigationItem.title = "Top Position"
...
extension TopPositionViewController: JSSegmentControlDataSource {
...
extension TopPositionViewController: JSSegmentControlDelegate {
