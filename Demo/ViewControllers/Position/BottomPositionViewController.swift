...
class BottomPositionViewController: UIViewController {
    ...
    private func constructView() {
        ...
        titleContainerStyle.position = .bottom
    ...
    private func constructNavigationBar() {
        self.navigationItem.title = "Bottom Position"
...
extension BottomPositionViewController: JSSegmentControlDataSource {
...
extension BottomPositionViewController: JSSegmentControlDelegate {
