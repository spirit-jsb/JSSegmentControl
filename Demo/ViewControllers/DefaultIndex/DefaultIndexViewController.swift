...
class DefaultIndexViewController: UIViewController {
    ...
    private let defaultIndex: Int = 3
    ...
    override func viewDidLayoutSubviews() {
        ...
        self.segmentControl?.selected(index: self.defaultIndex)
    }
    ...
    private func constructNavigationBar() {
        self.navigationItem.title = "Default Index"
...
extension DefaultIndexViewController: JSSegmentControlDataSource {
...
extension DefaultIndexViewController: JSSegmentControlDelegate {
